    ...
    <header className="py-14">
      <nav class="bg-white border-gray-200 flex align-middle justify-center">
        <ul className="flex justify-between px-32 w-full align-middle items-center max-lg:px-5 max-md:hidden">
          ...
          <li className="text-slate-600 hover:text-purple-800 cursor-pointer">Categorias</li>
        ...
        <ul className="flex justify-between w-full px-3">
          <li className="cursor-pointer inline-block">
            <div className="flex" onClick={intercambiarVisibilidad}>
        ...
        <div className="hidden p-3" id="mobile-menu">
          ...
          <ul className="flex flex-col justify-center">
            ...
            <li className="text-slate-600 hover:bg-zinc-100 p-2 rounded border border-t-0"> <NavLink to="/categorias" className={({isActive})=>isActive?"text-orange-500":""} >Categorias</NavLink> </li>
