...
export default function NotificacionComentario({ fecha, mensaje, calificacion, leido, descripcionServicio, idServicio }) {
            ...
            <div className='flex flex-col p-2  '>
                ...
                <div className='flex'>
                    ...
                    <div className='ml-auto mt-3 flex gap-4'>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 60 61" className='cursor-pointer' fill="none" onClick={handleCancelar}>
                            <path d="M30 53.9375C42.9442 53.9375 53.4375 43.4442 53.4375 30.5C53.4375 17.5558 42.9442 7.0625 30 7.0625C17.0558 7.0625 6.5625 17.5558 6.5625 30.5C6.5625 43.4442 17.0558 53.9375 30 53.9375Z" stroke="#E04556" strokeWidth="5.625" />
                            <path d="M15.9375 44.5625L45.9375 14.5625" stroke="#E04556" strokeWidth="5.625" />
                        </svg>
                    </div>
                </div>
