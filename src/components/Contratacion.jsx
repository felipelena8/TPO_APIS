...
export default function Contratacion({ descripcionServicio, mail, telefono, horario, motivo, idServicio }) {
    ...
    const handleFinalizar = () => { setActivo(false) }
    return (
        ...
        <div className='flex flex-col border rounded-lg p-3 w-64'>
            <div className="h-24 overflow-hidden ">
                ...
                <Link to={`/clase/${idServicio}`}>
                    <textarea className='h-full w-full cursor-pointer' defaultValue={descripcionServicio} />
                </Link>
            ...
            <button className="rounded border  mt-2 p-2 border-coral  text-white  bg-coral transition-all hover:bg-white hover:text-coral" onClick={() => handleFinalizar()}>Finalizar</button>
