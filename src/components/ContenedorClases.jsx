...
export default function ContenedorClases() {
  ...
  return (
    <div className='flex flex-col'>
      <button className={`mx-10 my-3 flex align-middle gap-2 border p-2 rounded-full w-min sm:hidden ${mostrarFiltro ? "bg-slate-200" : ""}`} onClick={() => { setMostrarFiltro(!mostrarFiltro) }}>
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 60 60" fill="none">
          <g clip-path="url(#clip0_293_166)">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M30 18.5714C30 17.5629 30.216 15.7143 30.552 15.7143H0V21.4286H30.552C30.216 21.4286 30 19.58 30 18.5714ZM53.448 15.7143C52.209 12.8571 48.912 10 45 10C40.029 10 36 13.8371 36 18.5714C36 23.3057 40.029 27.1429 45 27.1429C48.912 27.1429 52.209 24.2857 53.448 21.4286H60V15.7143H53.448ZM30 41.4286C30 42.4371 29.784 43.3886 29.448 44.2857H60V38.5714H29.448C29.784 38.5714 30 40.42 30 41.4286ZM24 41.4286C24 46.1629 19.971 50 15 50C11.088 50 7.791 47.1429 6.552 44.2857H0V38.5714H6.552C7.791 35.7143 11.088 32.8571 15 32.8571C19.971 32.8571 24 36.6943 24 41.4286Z" fill="black" />
          </g>
          <defs>
