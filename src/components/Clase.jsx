...
export default function Clase() {
    ...
    const getData = () => {
        buscarServicio(id)
            .then((data) => { setData(data); return Object.keys(data).length == 0 })
    ...
    return (
        <>
            ...
            {cargando ? (
                ...
                {modalContacto ? <div className="fixed top-0 left-0 z-10 w-full h-full  py-10 bg-black bg-opacity-80 flex justify-center items-center ">
                ...
                <div className="flex flex-col max-lg:px-10 lg:px-32 gap-10 max-md:items-center">
                    ...
                    <div className="flex flex-col">
                        <span className="text-5xl font-bold mb-5 max-md:text-xl">Comentarios</span>
                        <button className="self-start rounded-full p-2 border text-coral border-coral my-2 hover:bg-coral text-black hover:text-white transition-all" onClick={() => { setModalComentario(true) }}>Agregar un comentario</button>
